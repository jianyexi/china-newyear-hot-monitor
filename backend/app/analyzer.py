...
CATEGORY_RULES: dict[str, list[str]] = {
    "🎬 影视娱乐": [
        "电影", "电视剧", "综艺", "明星", "演员", "导演", "票房", "春晚", "晚会",
        "歌手", "演唱", "MV", "剧", "上映", "首播", "王菲", "节目单", "翻唱",
        "偶像", "选秀", "音乐", "视频", "短片", "纪录片", "动画",
    ],
    "🏀 体育赛事": [
        "比赛", "冠军", "球队", "运动员", "奥运", "世界杯", "联赛", "冰壶",
        "短道速滑", "滑雪", "体育", "赛事", "金牌", "武大靖", "马术", "足球",
        "篮球", "乒乓", "羽毛球", "游泳", "田径",
    ],
    "💰 财经商业": [
        "股票", "基金", "经济", "市场", "企业", "公司", "营收", "利润", "涨", "跌",
        "投资", "融资", "IPO", "消费", "购金", "车贷", "可口可乐", "销量",
        "价格", "成本", "营业", "商业", "品牌", "零售",
    ],
    "🌍 国际时事": [
        "美国", "俄", "欧盟", "日本", "韩国", "外交", "贸易", "制裁", "峰会",
        "国际", "海外", "中美", "中日", "中欧", "马六甲", "乌克兰", "以色列",
        "联合国", "北约", "特朗普", "拜登",
    ],
    "📱 科技数码": [
        "AI", "人工智能", "手机", "芯片", "机器人", "互联网", "数字", "算法",
        "大模型", "科技", "DeepSeek", "量产", "自动驾驶", "电动车", "5G",
        "卫星", "太空", "航天", "预测",
    ],
    "🏛️ 时政民生": [
        "政府", "政策", "改革", "民生", "教育", "医疗", "就业", "住房", "通报",
        "调查", "投案", "省政府", "立场", "王毅", "人民日报", "央视", "总书记",
        "两会", "大学", "校长", "警示",
    ],
    "🧧 春节年俗": settings.CNY_KEYWORDS,
    "😊 社会热议": [
        "热搜", "网友", "吐槽", "争议", "热议", "回应", "走红", "流浪",
        "喊话", "引发", "曝光", "真相", "谣言", "辟谣", "道歉",
    ],
    "🚗 出行交通": [
        "春运", "高铁", "机票", "火车", "12306", "航班", "出行", "旅客", "回家",
        "堵车", "高速", "地铁", "公交", "自驾", "宠物",
    ],
    "📷 生活方式": [
        "拍照", "旅行", "美食", "穿搭", "减肥", "健身", "护肤", "咖啡",
        "烹饪", "教程", "DIY", "家居", "装修", "宠物", "猫", "狗",
    ],
}
...
{chr(10).join(content_parts)}"""
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            if "choices" not in data or not data["choices"]:
                return "⚠️ AI 分析返回格式异常"
            return data["choices"][0].get("message", {}).get("content", "⚠️ AI 未返回内容")
